                           ...
                           const Eo *from, const Eo *to, double pos_map)
{
   ...
   eo_do(obj,
         efl_gfx_shape_stroke_scale_set(interpolate(property_from.scale, property_to.scale, pos_map)),
         efl_gfx_shape_stroke_color_set(interpolatei(property_from.r, property_to.r, pos_map),
         ...
         efl_gfx_color_set(interpolatei(property_from.fr, property_to.fr, pos_map),
         ...
         efl_gfx_shape_stroke_width_set(interpolate(property_from.w, property_to.w, pos_map)),
