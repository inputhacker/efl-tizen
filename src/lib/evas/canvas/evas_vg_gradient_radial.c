...
static void
_efl_vg_gradient_radial_render_pre(Evas_Object_Protected_Data *vg_pd EINA_UNUSED,
                                   Efl_VG *obj,
                                   Efl_VG_Base_Data *nd,
                                   ...
                                   void *data)
{
   ...
   if (!nd->renderer)
     {
        eo_do(surface, nd->renderer = ector_surface_renderer_factory_new(ECTOR_RENDERER_GENERIC_GRADIENT_RADIAL_MIXIN));
     }
