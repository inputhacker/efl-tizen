...
/*    void (*image_rotation_set)              (void *data, void *image); */
   ...
   void *(*gl_context_create)            (void *data, void *share_context, int version, int ctx_flag, void *(*native_context_get)(void *ctx), void *(*engine_data_get)(void *evasgl));
   ...
   void *(*ector_surface_destroy)        (void *data, void *surface);
