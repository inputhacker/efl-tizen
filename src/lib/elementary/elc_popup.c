...
static Eina_Error _notify_style_set(Evas_Object *obj, const char *style);
/* END */
...
EOLIAN static Eina_Bool
_elm_popup_efl_ui_widget_focus_next(Eo *obj, Elm_Popup_Data *sd, Efl_Ui_Focus_Direction dir, Evas_Object **next, Elm_Object_Item **next_item)
{
   Evas_Object *ao;
...
_elm_popup_efl_ui_widget_atspi(Eo *obj, Elm_Popup_Data *_pd EINA_UNUSED, Eina_Bool is_atspi)
{
   ...
   if (STATE_TYPE_GET(ss, EFL_ACCESS_STATE_TYPE_SHOWING))
     {
