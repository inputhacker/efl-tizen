...
_efl_ui_win_efl_ui_widget_focus_next_manager_is(Eo *obj EINA_UNUSED, Efl_Ui_Win_Data *_pd EINA_UNUSED)
{
   return EINA_TRUE;
}
   ...
   if (wd->subobjs)
     {
        ...
        efl_ui_widget_focus_list_next_get(obj, items, list_data_get, dir, next, next_item);
...
EOLIAN static Eina_Bool
_efl_ui_win_efl_ui_widget_focus_direction_manager_is(Eo *obj EINA_UNUSED, Efl_Ui_Win_Data *_pd EINA_UNUSED)
{
   return EINA_TRUE;
}

EOLIAN static Eina_Bool
_efl_ui_win_efl_ui_widget_focus_direction(Eo *obj, Efl_Ui_Win_Data *_pd EINA_UNUSED, const Evas_Object *base, double degree, Evas_Object **direction, Elm_Object_Item **direction_item, double *weight)
{
   const Eina_List *items;
   void *(*list_data_get)(const Eina_List *list);
...
// TIZEN_ONLY(20171114) Accessibility Highlight Frame added
static void
_elm_win_accessibility_highlight_callbacks_add(Efl_Ui_Win_Data *sd)
{
...
// TIZEN_ONLY(20171114) Accessibility Highlight Frame added
static void
_elm_win_accessibility_highlight_init(Efl_Ui_Win_Data *sd, Evas_Object *atarget)
{
...
//TIZEN_ONLY(20180131):Added resize,end signal for mouse up
        edje_object_signal_callback_add
           (sd->frame_obj, "efl,action,resize,end", "*",
           _elm_win_frame_cb_resize_end, obj);
//
        edje_object_signal_callback_add
...
// if (pd->type == EFL_UI_WIN_TYPE_FAKE)
   if (pd->type == EFL_UI_WIN_TYPE_FAKE && evas_object_data_get(pd->obj, "__fake_make_wl2"))
     {
