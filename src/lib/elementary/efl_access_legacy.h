...
{
   ELM_ATSPI_GESTURE_ONE_FINGER_HOVER,
   ELM_ATSPI_GESTURE_TWO_FINGERS_HOVER,
   ELM_ATSPI_GESTURE_THREE_FINGERS_HOVER,
   ELM_ATSPI_GESTURE_ONE_FINGER_FLICK_LEFT,
   ELM_ATSPI_GESTURE_ONE_FINGER_FLICK_RIGHT,
   ELM_ATSPI_GESTURE_ONE_FINGER_FLICK_UP,
   ELM_ATSPI_GESTURE_ONE_FINGER_FLICK_DOWN,
   ELM_ATSPI_GESTURE_TWO_FINGERS_FLICK_LEFT,
   ELM_ATSPI_GESTURE_TWO_FINGERS_FLICK_RIGHT,
   ELM_ATSPI_GESTURE_TWO_FINGERS_FLICK_UP,
   ELM_ATSPI_GESTURE_TWO_FINGERS_FLICK_DOWN,
   ELM_ATSPI_GESTURE_THREE_FINGERS_FLICK_LEFT,
   ELM_ATSPI_GESTURE_THREE_FINGERS_FLICK_RIGHT,
   ELM_ATSPI_GESTURE_THREE_FINGERS_FLICK_UP,
   ELM_ATSPI_GESTURE_THREE_FINGERS_FLICK_DOWN,
   ELM_ATSPI_GESTURE_ONE_FINGER_SINGLE_TAP,
   ELM_ATSPI_GESTURE_ONE_FINGER_DOUBLE_TAP,
   ELM_ATSPI_GESTURE_ONE_FINGER_TRIPLE_TAP,
   ELM_ATSPI_GESTURE_TWO_FINGERS_SINGLE_TAP,
   ELM_ATSPI_GESTURE_TWO_FINGERS_DOUBLE_TAP,
   ELM_ATSPI_GESTURE_TWO_FINGERS_TRIPLE_TAP,
   ELM_ATSPI_GESTURE_THREE_FINGERS_SINGLE_TAP,
   ELM_ATSPI_GESTURE_THREE_FINGERS_DOUBLE_TAP,
   ELM_ATSPI_GESTURE_THREE_FINGERS_TRIPLE_TAP,
   ELM_ATSPI_GESTURE_ONE_FINGER_FLICK_LEFT_RETURN,
   ELM_ATSPI_GESTURE_ONE_FINGER_FLICK_RIGHT_RETURN,
   ELM_ATSPI_GESTURE_ONE_FINGER_FLICK_UP_RETURN,
   ELM_ATSPI_GESTURE_ONE_FINGER_FLICK_DOWN_RETURN,
   ELM_ATSPI_GESTURE_TWO_FINGERS_FLICK_LEFT_RETURN,
   ELM_ATSPI_GESTURE_TWO_FINGERS_FLICK_RIGHT_RETURN,
   ELM_ATSPI_GESTURE_TWO_FINGERS_FLICK_UP_RETURN,
   ELM_ATSPI_GESTURE_TWO_FINGERS_FLICK_DOWN_RETURN,
   ELM_ATSPI_GESTURE_THREE_FINGERS_FLICK_LEFT_RETURN,
   ELM_ATSPI_GESTURE_THREE_FINGERS_FLICK_RIGHT_RETURN,
