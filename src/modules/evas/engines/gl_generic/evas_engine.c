...
static void *
eng_gl_context_create(void *data, void *share_context, int version, int ctx_flag,
                      ...
                      void *(*engine_data_get)(void *))
{
   ...
   EVGLINIT(data, NULL);
   return evgl_context_create(data, sctx, version, ctx_flag, native_context_get, engine_data_get);
}
