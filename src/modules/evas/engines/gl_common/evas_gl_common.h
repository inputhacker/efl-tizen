...
#  define glTexImage2D(...) GL_ERROR_TRACE(glTexImage2D, glTexImage2D, #__VA_ARGS__, __VA_ARGS__)
...
#  define eglsym_eglDestroyImage(...) GL_ERROR_TRACE_RET(unsigned int, eglDestroyImage, secsym_eglDestroyImage, #__VA_ARGS__, __VA_ARGS__)
